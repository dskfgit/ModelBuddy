...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.splash_build_button).setOnTouchListener(mDelayHideTouchListener);
        findViewById(R.id.splash_paints_button).setOnTouchListener(mDelayHideTouchListener);
        findViewById(R.id.splash_recipes_button).setOnTouchListener(mDelayHideTouchListener);
    }
