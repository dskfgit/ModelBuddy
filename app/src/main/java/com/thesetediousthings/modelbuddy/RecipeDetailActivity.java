...
public class RecipeDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aRecipe = recipeFactory.getItems_map().get(getIntent().getStringExtra(BasicItem.ARG_ITEM_ID));
        ...
        if (savedInstanceState == null) {
            ...
            //arguments.putString(BasicItem.ARG_ITEM_ID, getIntent().getStringExtra(RecipeDetailFragment.ARG_ITEM_ID));
